...
txt1=text(100,ymina+2*((ymin-ymina)/4),['Contraste Inicial: ', num2str(ci,'%.3f'), ' \pm ',num2str(stdi,'%.3f')], 'BackgroundColor',[1 1 1]);
txt2=text(100,ymina+1*((ymin-ymina)/4),['Contraste Final:   ', num2str(cf,'%.3f'), ' \pm ',num2str(stdf,'%.3f')], 'BackgroundColor',[1 1 1]);
