...
txt1=text(10,ymina+2*((ymin-ymina)/4),['Contraste Inicial: ', num2str(ci,'%.2f'), ' \pm ',num2str(stdi,'%.2f')], 'BackgroundColor',[1 1 1]);
txt2=text(10,ymina+1*((ymin-ymina)/4),['Contraste Final:   ', num2str(cf,'%.2f'), ' \pm ',num2str(stdf,'%.2f')], 'BackgroundColor',[1 1 1]);
