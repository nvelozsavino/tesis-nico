...
int Ruido::initRuido(string FileSpectrum, unsigned int MaxPoints){
    return fileSpectrum(FileSpectrum, MaxPoints);
}
...
//Funciones Set
int Ruido::fileSpectrum(string FileSpectrum, unsigned int MaxPoints){
    FILE *file;
    unsigned int i=0;
    int response;
